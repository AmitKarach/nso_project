...
def test_delete_only_messages_with_applicationId():
    ...
    """
    test_utils.enter_data_to_db('application_id', 5)
    data = test_utils.get_message_object(2, 'aaaa', 'cccc', ['avi aviv', 'moshe cohen'], 'Hi, how are you today?')
    test_utils.post_message(data)
    params = {'applicationId': 1}
    response = test_utils.delete_message(params)
...
def test_delete_only_messages_with_sessionId():
    ...
    """
    test_utils.enter_data_to_db('session_id', 5)
    data = test_utils.get_message_object(1, 'bbbb', 'cccc', ['avi aviv', 'moshe cohen'], 'Hi, how are you today?')
    test_utils.post_message(data)
    params = {'sessionId': 'aaaa'}
    response = test_utils.delete_message(params)
...
def test_delete_only_messages_with_messageId():
    ...
    """
    data1 = test_utils.get_message_object(1, 'bbbb', 'a', ['avi aviv', 'moshe cohen'], 'Hi, how are you today?')
    data2 = test_utils.get_message_object(1, 'bbbb', 'b', ['avi aviv', 'moshe cohen'], 'Hi, how are you today?')
